...
public class RandomizedCollection {
    ...
    /** Inserts B value to the collection. Returns true if the collection did not already contain the specified element. */
    ...
    /** Removes B value from the collection. Returns true if the collection contained the specified element. */
    ...
    /** Get B random element from the collection. */
